  ...
  return (
    <div>
      <header className='w-full h-14 shadow-md flex justify-around items-center'>
        ...
        {/* Search input */}
        <div className='flex items-center space-x-2 py-2 bg-gray-200 my-2 px-2 outline-none border rounded-sm focus:border-[#aaaaaa]'>
          <label htmlFor='search'>
            <BsSearch className='text-gray-500' />
          </label>
          <input type='search' name='search' id='search' placeholder='Search' className='bg-gray-200 px-2 outline-none' />
        </div>
