...
<div className='flex items-center space-x-2 py-2 bg-gray-100 my-2 px-2 outline-none border rounded-sm focus:border-[#aaaaaa]'>
<label htmlFor="search"><BsSearch className='text-gray-500' /></label>
